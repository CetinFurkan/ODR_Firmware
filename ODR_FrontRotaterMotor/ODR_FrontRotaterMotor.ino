/*
   ...
   Modified on 28/11/2020:
    - setAngleTargetAbs() has proper mapping func
...
void setAngleTargetAbs(int _angle) { //_angle: [-127,+127]
  _angle = map(_angle, -127, 127, -ANGLE_RANGE, ANGLE_RANGE);
  
  float angleTargetPre = angleTarget;
  angleTarget = ANGLE_CENTER + _angle ;
